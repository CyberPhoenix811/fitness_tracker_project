...
for col in outlier_col:
    ...
    plot_binary_outliers(dataset,col, outlier_col= col + "_outlier", reset_index= True)
# --------------------------------------------------------------
...
dataset.loc[dataset["gyr_z_outlier"] == True, "gyr_z"] = np.nan
...
outlier_removed_df.to_pickle("../../src/features/outliers_removed_chauvenet.pkl")